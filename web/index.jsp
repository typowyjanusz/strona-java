...
<html>
    ...
    <body>
		...
		<div id="navigation">
			<ul>
				<li class="first selected"><a href="index.jsp">&nbspHome</a></li>
				
				<% if(session.getAttribute("sessionName")==null){
                                    out.print("<li><a href=\"registration.jsp\">Rejestracja</a></li>");
	...
	<div id="contents">
        ...
        ResultSet resultset = statement.executeQuery("select * from webpage.news where visibility=1 order by date desc;");
        %>
            <% while(resultset.next()){ %>
            <span><%= resultset.getString(2) %></span>
            <p><%= resultset.getString(3) %><br><br>
                Autor: <%= resultset.getString(4) %><br>
                Data: <%= resultset.getString(6) %><br></p>                       
            <% } %>
                            
                            <span>Witaj!</span>
				
				<p>Serdecznie zapraszamy do zarejestrowania się. 
                                    Po rejestracji można dodawać posty lecz każdy 
                                     z nich zostać musi zatwierdzony przez administratora.</p>
			</div>
		</div>
	</div> <!-- /#contents -->
	<div id="footer">
